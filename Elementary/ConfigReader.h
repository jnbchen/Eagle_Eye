/** Klasse zum Einlesen und Verwalten von Konfigurationsdateien und
 Kommandozeilenparametern entwickelt im Rahmen des Brainstormers Tribots
 Projektes durch Martin Lauer (lauer@mrt.uka.de) und geeignet fuer Linux
 und Windows */

#ifndef _DerWeg_ConfigReader_h_
#define _DerWeg_ConfigReader_h_
...
namespace DerWeg {
  ...
  /** ConfigReader, bessere Alternative zu Arturs ValueReader.
  ...
  */
  ...
  public:
    ...
    /** ueberschreibt eine Konfigurationsdatei. Die Quellatei wird in
      eine .bak-Datei umbenannt und eine neue Datei geschrieben. Zu den in der
      Quelldatei auftretenden Schluesseln werden die gespeicherten Werte
      ausgegeben. Nicht auftretende Schluessel werden ignoriert.
