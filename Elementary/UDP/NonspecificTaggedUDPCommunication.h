...
#ifndef _DerWeg_NonspecificTaggedUDPCommunication_h_
#define _DerWeg_NonspecificTaggedUDPCommunication_h_
...
namespace DerWeg {
  ...
  public:
    ...
    NonspecificTaggedUDPCommunication (const char*, unsigned int =8188) throw (std::bad_alloc);
