...
#ifndef _DerWeg_TaggedUDPCommunication_h_
#define _DerWeg_TaggedUDPCommunication_h_
...
namespace DerWeg {
  ...
  public:
    ...
    TaggedUDPCommunication (const char*, unsigned int =8188) throw (std::bad_alloc);
