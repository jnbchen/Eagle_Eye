/** Klasse zum Herstellen einfacher UDP-Verbindungen ohne weiteren
 Schnickschnack (sowohl Client-seitig als auch Server-seitig). Entwickelt im
 Rahmen des Brainstormers Tribots Projektes durch Martin Lauer
 (lauer@mrt.uka.de) und getestet unter Linux */

#ifndef _DerWeg_UDPSocket_h_
#define _DerWeg_UDPSocket_h_
