...
Vec DerWeg::operator* (double s, Vec v) throw () {
  Vec res (v);
  res*=s;
  return res;
}
...
bool DerWeg::linearly_independent (const Vec v1, const Vec v2) {
